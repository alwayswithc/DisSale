$(function() {
	...
	var infoUrl = '/DisSale/product/getproductbyid?productId=' + productId;
	var categoryUrl = '/DisSale/product/categoryList';
	var productPostUrl = '/DisSale/product/modify';
	var isEdit = false;
	if (productId) {
		getInfo(productId);
		isEdit = true;
		    ...
		    $.getJSON(
						...
						function(data) {
							if (data.success) {
								...
								$('#product-num').val(product.productNum);
	...
	$('#submit').click(
			function() {
				...
				product.productSize = $('#product-size').val();
